...
let ProductService = exports.ProductService = class ProductService {
    ...
    getPriceFilter(minPrice, maxPrice) {
        ...
        if (minPrice) {
            priceFilter = Object.assign(Object.assign({}, priceFilter), { gte: minPrice });
        }
        if (maxPrice) {
            priceFilter = Object.assign(Object.assign({}, priceFilter), { lte: maxPrice });
        }
        return {
            price: priceFilter
        };
    ...
    async delete(id) {
        const a = await this.prisma.product.delete({ where: { id } });
        return a;
    }
};
